...
import {InfoBlock, ProjectWrapper, ProjectImgContainer, ProjectImg, ProjectBody, Title3, ProjectList, ProjectListItem, ProjectDescription, ProjectLinkList, ProjectLink} from './style';
